...
class _CandidateListPageState extends State<CandidateListPage> {
  List<Candidat> candidates = [
    Candidat(
      ...
      sex: 'Male',
      party: 'Party D',
      description: 'Djohou, né djohou le 23 octobre 1954 à Paris, est un économiste franco-béninois, ayant fait carrière notamment comme banquier d\'affaires puis comme PDG du fonds d\'investissement européen PAI Partners. Il a été Premier ministre du Bénin de juin 2015 à avril 2016.',
      photo: '',
    ),
    Candidat(
      name: 'jko',
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    TextButton(
                      onPressed: () {},
                      child: Text('Présidentielle', style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold)),
                    ),
                    TextButton(
                      onPressed: () {},
